/* a simple convolution with cuDNN */
// compile:
// nvcc -std=c++14 -O3 -o conv -I ../../include/ conv.cu `pkg-config --libs opencv` -L ../../lib/ -lcudnn -lopencv_core
...
int main(int argc, char const **argv)
{
  ...
  save_image("cudnn-out.png", h_output, image.rows, image.cols);
